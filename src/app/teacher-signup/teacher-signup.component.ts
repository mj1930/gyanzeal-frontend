...
export class TeacherSignupComponent implements OnInit {
  ...
  createAccount() {
    ...
    this.checkAndUpdateCourseAndClasses();
  ...
  addSubject() {
    ...
    if (courseArray.length > 0 && courseArray.indexOf(selectedCourse) == -1) {
      ...
      this.coursesArray = this.coursesArray.concat(this.teacherForm.controls.courses.value);
  ...
  addGZSpecialSubject() {
    ...
    if (courseArray.length > 0 && courseArray.indexOf(selectedCourse) == -1) {
      ...
      this.gzSpecialCourses = this.gzSpecialCourses.concat(this.teacherForm.controls.gzcourses.value);
  ...
  checkAndUpdateCourseAndClasses() {
    ...
    } else if (this.coursesArray.length > 0 && this.gzSpecialCourses.length > 0) {
